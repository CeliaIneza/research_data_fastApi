...
try:
    ...
    research_projects_api = requests.get('http://127.0.0.1:8000/api/v1/researchprojects')
    research_projects_api.raise_for_status()
    research_projects_api_data = research_projects_api.json()

    # Fetch Researchers data
    researchers_api = requests.get('http://127.0.0.1:8000/api/v1/researchers')
    ...
    # Display DataFrames
    print("Research Projects DataFrame:")
    print(rdf)
